...
class CookieNod_Google_Consent_Mode {
    ...
    public function output_gcm_default_consent() {
        ...
        wp_register_script('cookienod-gcm-default', false, array(), COOKIENOD_EXTENDED_VERSION, false);
    ...
    private function output_gtm_consent_state() {
        wp_register_script('cookienod-gcm-gtm', false, array(), COOKIENOD_EXTENDED_VERSION, false);
    ...
    public function output_gcm_update_script() {
        ...
        wp_register_script('cookienod-gcm-update', false, array(), COOKIENOD_EXTENDED_VERSION, false);
    ...
    public function get_settings_fields() {
        return array(
            'enable_google_consent_mode' => array(
                'type' => 'checkbox',
                'label' => __('Enable Google Consent Mode v2', 'cookienod-extended'),
                'description' => __('Integrates with Google Tag Manager and Google Analytics for consent-based data collection', 'cookienod-extended'),
            ),
            'gcm_enable_gtm' => array(
                'type' => 'checkbox',
                'label' => __('Enable Google Tag Manager Integration', 'cookienod-extended'),
                'description' => __('Pass consent state to GTM dataLayer', 'cookienod-extended'),
            ),
            'gcm_redact_ads_data' => array(
                'type' => 'checkbox',
                'label' => __('Redact Ads Data When Denied', 'cookienod-extended'),
                'description' => __('Automatically redact advertising data when marketing consent is denied', 'cookienod-extended'),
            ),
        );
    }
