...
/**
 * Class CookieNodExtended_Frontend
...
class CookieNodExtended_Frontend {
    ...
    private function init() {
        // Frontend hooks - output_script is called by CookieNodExtended_Core
    ...
    public function output_script() {
        ...
        // Text translations
        $texts = array(
            'title' => esc_attr($this->options['banner_title'] ?? __('Cookie Preferences', 'cookienod-extended')),
            'description' => esc_attr($this->options['banner_description'] ?? __('We use cookies to enhance your experience. Choose your preferences below.', 'cookienod-extended')),
            'accept' => esc_attr($this->options['btn_accept'] ?? __('Accept All', 'cookienod-extended')),
            'reject' => esc_attr($this->options['btn_reject'] ?? __('Reject', 'cookienod-extended')),
            'customize' => esc_attr($this->options['btn_customize'] ?? __('Customize', 'cookienod-extended')),
            'save' => esc_attr($this->options['btn_save'] ?? __('Save Preferences', 'cookienod-extended')),
            'settings_title' => esc_attr($this->options['settings_title'] ?? __('Cookie Settings', 'cookienod-extended')),
            'category_necessary' => esc_attr($this->options['category_necessary'] ?? __('Necessary', 'cookienod-extended')),
            'category_functional' => esc_attr($this->options['category_functional'] ?? __('Functional', 'cookienod-extended')),
            'category_analytics' => esc_attr($this->options['category_analytics'] ?? __('Analytics', 'cookienod-extended')),
            'category_marketing' => esc_attr($this->options['category_marketing'] ?? __('Marketing', 'cookienod-extended')),
            'label_required' => esc_attr($this->options['label_required'] ?? __('Required', 'cookienod-extended')),
        );
        ...
        if ($theme === 'dark') {
            ...
            wp_register_style('cookienod-theme', false, [], COOKIENOD_EXTENDED_VERSION);
