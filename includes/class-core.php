...
class CookieNodExtended_Core {
     ...
     *
     * @var CookieNodExtended_Core|null
     */
    ...
    private function init() {
        ...
        // Add settings link
        add_filter('plugin_action_links_' . plugin_basename(COOKIENOD_EXTENDED_PLUGIN_FILE), array($this, 'add_settings_link'));
    ...
    private function load_dependencies() {
        ...
        require_once COOKIENOD_EXTENDED_PLUGIN_DIR . 'includes/class-admin.php';
        require_once COOKIENOD_EXTENDED_PLUGIN_DIR . 'includes/class-frontend.php';
        require_once COOKIENOD_EXTENDED_PLUGIN_DIR . 'includes/class-compliance.php';
        require_once COOKIENOD_EXTENDED_PLUGIN_DIR . 'includes/class-google-consent-mode.php';
        require_once COOKIENOD_EXTENDED_PLUGIN_DIR . 'includes/class-script-blocker.php';
        require_once COOKIENOD_EXTENDED_PLUGIN_DIR . 'includes/class-custom-css.php';
        require_once COOKIENOD_EXTENDED_PLUGIN_DIR . 'includes/class-ab-testing.php';
        require_once COOKIENOD_EXTENDED_PLUGIN_DIR . 'includes/class-policy-generator.php';
        require_once COOKIENOD_EXTENDED_PLUGIN_DIR . 'includes/class-woocommerce.php';
        require_once COOKIENOD_EXTENDED_PLUGIN_DIR . 'includes/class-plugin-compat.php';
    }
    ...
    public function start_output_buffering() {
        $frontend = new CookieNodExtended_Frontend($this->options);
    ...
    public function add_settings_link($links) {
        $settings_link = '<a href="' . admin_url('admin.php?page=cookienod-settings') . '">' . __('Settings', 'cookienod-extended') . '</a>';
    ...
    public function api_key_changed_notice() {
        ...
        if (!$screen || strpos((string) $screen->id, 'cookienod-extended') === false) {
            return;
        }

        delete_transient('cookienod_api_key_changed_notice');

        echo '<div class="notice notice-warning is-dismissible"><p>' . esc_html__('API key changed, please verify again.', 'cookienod-extended') . '</p></div>';
    }
