...
class CookieNod_AB_Testing {
    ...
    private function init() {
        ...
        // Track events (assign_variant is registered in CookieNodExtended_Core::init_components)
    ...
    public function ajax_create_test() {
        ...
        if ($result) {
            wp_send_json_success(array(
                ...
                'message' => __('Test created successfully', 'cookienod-extended'),
            ));
        } else {
    ...
    public function ajax_set_winner() {
        ...
        wp_send_json_success(array(
            'message' => __('Winner set successfully', 'cookienod-extended'),
            'test_id' => $test_id,
            'winner_id' => $winner_id,
        ));
    }
