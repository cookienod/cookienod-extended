...
class CookieNod_Database {
    ...
    public function check_tables() {
        ...
        if (!empty($missing_tables)) {
            ...
            <div class="notice notice-error">
                <p><strong>CookieNod:</strong> <?php esc_html_e('The following database tables are missing:', 'cookienod-extended'); ?> <code><?php echo esc_html(implode(', ', $missing_tables)); ?></code></p>
                <p><a href="<?php echo esc_url($repair_url); ?>" class="button button-primary"><?php esc_html_e('Create Missing Tables', 'cookienod-extended'); ?></a></p>
            </div>
            <?php
        }
    }
    ...
    public function handle_repair() {
        ...
        if (!current_user_can('manage_options')) {
            wp_die(esc_html__('Unauthorized', 'cookienod-extended'));
        }
        ...
        if (!wp_verify_nonce($nonce_value, 'cookienod_repair_tables')) {
            wp_die(esc_html__('Invalid nonce', 'cookienod-extended'));
        }
    ...
    public function show_created_notice() {
        ...
        <div class="notice notice-success is-dismissible">
            <p><strong>CookieNod:</strong> <?php esc_html_e('Database tables created successfully.', 'cookienod-extended'); ?></p>
        </div>
        <?php
    }
}
