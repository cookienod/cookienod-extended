...
class CookieNodExtended_Admin {
    ...
    public function add_menu() {
        add_menu_page(
            __('CookieNod', 'cookienod-extended'),
            __('CookieNod', 'cookienod-extended'),
            'manage_options',
            'cookienod',
        ...
        add_submenu_page(
            'cookienod',
            __('Dashboard', 'cookienod-extended'),
            __('Dashboard', 'cookienod-extended'),
            'manage_options',
            'cookienod',
            array($this, 'render_dashboard_page')
        ...
        add_submenu_page(
            'cookienod',
            __('Settings', 'cookienod-extended'),
            __('Settings', 'cookienod-extended'),
            'manage_options',
            'cookienod-settings',
        ...
        add_submenu_page(
            'cookienod',
            __('Cookie Manager', 'cookienod-extended'),
            __('Cookie Manager', 'cookienod-extended'),
            'manage_options',
            'cookienod-cookies',
        ...
        add_submenu_page(
            'cookienod',
            __('Consent Log', 'cookienod-extended'),
            __('Consent Log', 'cookienod-extended'),
            'manage_options',
        ...
        add_submenu_page(
            'cookienod',
            __('A/B Testing', 'cookienod-extended'),
            __('A/B Testing', 'cookienod-extended'),
            'manage_options',
        ...
        add_submenu_page(
            'cookienod',
            __('Customize CSS', 'cookienod-extended'),
            __('Customize CSS', 'cookienod-extended'),
            'manage_options',
        ...
        add_submenu_page(
            'cookienod',
            __('Cookie Policy', 'cookienod-extended'),
            __('Cookie Policy', 'cookienod-extended'),
            'manage_options',
            'cookienod-policy',
    ...
    public function enqueue_scripts($hook) {
        ...
        wp_enqueue_style(
            'cookienod-admin',
            COOKIENOD_EXTENDED_PLUGIN_URL . 'assets/css/admin.css',
            array(),
        ...
        wp_enqueue_script(
            'cookienod-admin',
            COOKIENOD_EXTENDED_PLUGIN_URL . 'assets/js/admin.js',
            array('jquery'),
            COOKIENOD_EXTENDED_VERSION,
            true
        );
        ...
        wp_localize_script('cookienod-admin', 'cookienodWp', array(
            ...
            'strings' => array(
                'verifying' => __('Verifying...', 'cookienod-extended'),
                'verified'  => __('API Key Verified!', 'cookienod-extended'),
                'invalid'   => __('Invalid API Key', 'cookienod-extended'),
                'error'     => __('Error occurred', 'cookienod-extended'),
            ),
        ));
    }
    ...
    public function ajax_verify_api_key() {
        ...
        if (is_wp_error($response)) {
            delete_option('cookienod_wp_site_info');
            wp_send_json_error(__('Failed to connect to Cookiebot API. Please check your server connectivity.', 'cookienod-extended'));
        }
    ...
    public function render_dashboard_page() {
        include COOKIENOD_EXTENDED_PLUGIN_DIR . 'templates/dashboard.php';
    }
    ...
    public function render_settings_page() {
        include COOKIENOD_EXTENDED_PLUGIN_DIR . 'templates/settings.php';
    }
    ...
    public function render_cookies_page() {
        ...
        include COOKIENOD_EXTENDED_PLUGIN_DIR . 'templates/cookies.php';
    }
    ...
    public function render_consent_log_page() {
        ...
        include COOKIENOD_EXTENDED_PLUGIN_DIR . 'templates/consent-log.php';
    }
    ...
    public function render_ab_testing_page() {
        ...
        include COOKIENOD_EXTENDED_PLUGIN_DIR . 'templates/ab-testing.php';
    }
...
.status-badge.status-completed {
    ...
    public function render_custom_css_page() {
        include COOKIENOD_EXTENDED_PLUGIN_DIR . 'templates/custom-css.php';
    }
    ...
    public function render_policy_page() {
        include COOKIENOD_EXTENDED_PLUGIN_DIR . 'templates/policy-generator.php';
    }
    ...
    public function get_cookie_description($name, $category) {
        $descriptions = array(
            // Necessary
            'PHPSESSID' => __('Session identifier for PHP applications.', 'cookienod-extended'),
            'wordpress_' => __('WordPress authentication and session cookies.', 'cookienod-extended'),
            'wp-' => __('WordPress core functionality cookies.', 'cookienod-extended'),
            'wordpress_logged_in' => __('Indicates when a user is logged in.', 'cookienod-extended'),
            'wp-settings' => __('Stores user interface preferences.', 'cookienod-extended'),
            'wordpress_test_cookie' => __('Tests if browser accepts cookies.', 'cookienod-extended'),
            'wp_woocommerce_session' => __('WooCommerce shopping session.', 'cookienod-extended'),
            'woocommerce_' => __('WooCommerce e-commerce functionality.', 'cookienod-extended'),
            'wc_' => __('WooCommerce cart and session data.', 'cookienod-extended'),
            'cart_' => __('Shopping cart identifier.', 'cookienod-extended'),
            '_csrf' => __('Security token for form submissions.', 'cookienod-extended'),
            'csrftoken' => __('Cross-site request forgery protection.', 'cookienod-extended'),
            'session' => __('Generic session management.', 'cookienod-extended'),
            'auth' => __('Authentication token.', 'cookienod-extended'),
            'login' => __('Login session identifier.', 'cookienod-extended'),
            'security' => __('Security-related functionality.', 'cookienod-extended'),
            '__cf' => __('Cloudflare security and performance.', 'cookienod-extended'),

            // Analytics
            '_ga' => __('Google Analytics - distinguishes users.', 'cookienod-extended'),
            '_gid' => __('Google Analytics - distinguishes users (24 hours).', 'cookienod-extended'),
            '_gat' => __('Google Analytics - throttles request rate.', 'cookienod-extended'),
            '_utm' => __('Google Analytics campaign tracking.', 'cookienod-extended'),
            '__hstc' => __('HubSpot tracking cookie.', 'cookienod-extended'),
            '_hj' => __('Hotjar analytics and user recordings.', 'cookienod-extended'),
            'sbjs_' => __('SourceBuster attribution tracking.', 'cookienod-extended'),
            '_fbp' => __('Facebook Pixel tracking.', 'cookienod-extended'),
            'fr' => __('Facebook advertising cookie.', 'cookienod-extended'),
            'IDE' => __('Google DoubleClick advertising.', 'cookienod-extended'),
            'NID' => __('Google preferences and advertising.', 'cookienod-extended'),
            'test_cookie' => __('Tests browser cookie support.', 'cookienod-extended'),

            // Functional
            'lang' => __('Language preference setting.', 'cookienod-extended'),
            'language' => __('Website language selection.', 'cookienod-extended'),
            'currency' => __('Currency preference for e-commerce.', 'cookienod-extended'),
            'theme' => __('User theme/visual preference.', 'cookienod-extended'),
            'preferences' => __('User preference settings.', 'cookienod-extended'),
            'settings' => __('Application settings.', 'cookienod-extended'),
        );
        ...
        $category_desc = array(
            'necessary' => __('Essential for website operation.', 'cookienod-extended'),
            'functional' => __('Enhances website functionality.', 'cookienod-extended'),
            'analytics' => __('Helps analyze website usage.', 'cookienod-extended'),
            'marketing' => __('Used for advertising purposes.', 'cookienod-extended'),
            'uncategorized' => __('Cookie purpose not yet classified.', 'cookienod-extended'),
        );
