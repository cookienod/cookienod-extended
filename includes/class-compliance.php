...
class CookieNod_Compliance {
    ...
    /**
     * Get visitor IP (anonymized for GDPR compliance)
     *
    ...
    public function get_consent_text($regulation = 'gdpr', $type = 'banner') {
        $texts = array(
            'gdpr' => array(
                'banner' => __('We use cookies to enhance your browsing experience, serve personalized content, and analyze our traffic. By clicking "Accept All", you consent to our use of cookies.', 'cookienod-extended'),
                'necessary' => __('Necessary cookies are essential for the website to function properly.', 'cookienod-extended'),
                'functional' => __('Functional cookies help perform certain functionalities like sharing website content on social media platforms.', 'cookienod-extended'),
                'analytics' => __('Analytics cookies help us understand how visitors interact with our website.', 'cookienod-extended'),
                'marketing' => __('Marketing cookies are used to deliver personalized advertisements.', 'cookienod-extended'),
            ),
            'ccpa' => array(
                'banner' => __('We use cookies and similar technologies to improve your experience and for advertising purposes. You can customize your preferences or opt out of the sale of personal information.', 'cookienod-extended'),
                'do_not_sell' => __('Do Not Sell My Personal Information', 'cookienod-extended'),
            ),
            'lgpd' => array(
                'banner' => __('Utilizamos cookies para melhorar sua experiça e analisar nosso tráfego. Ao clicar em "Aceitar Todos", você concorda com o uso de cookies.', 'cookienod-extended'),
            ),
        );
