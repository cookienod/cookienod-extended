...
<div class="wrap cookienod-policy-generator">
    ...
    <?php if ($cookienod_policy_page) : ?>
        <div class="notice notice-success">
            <p>
                <?php esc_html_e('Your Cookie Policy page is live:', 'cookienod-extended'); ?>
            ...
            <p>
                <a href="<?php echo esc_url(get_edit_post_link($cookienod_policy_page)); ?>" class="button">
                    <?php esc_html_e('Edit Page', 'cookienod-extended'); ?>
                </a>
            </p>
        </div>
    <?php endif; ?>
    ...
    <div class="cookienod-card">
        <div class="nav-tab-wrapper">
            <a href="#generate" class="nav-tab nav-tab-active"><?php esc_html_e('Generate', 'cookienod-extended'); ?></a>
            <a href="#detected-cookies" class="nav-tab"><?php esc_html_e('Detected Cookies', 'cookienod-extended'); ?></a>
            <a href="#settings" class="nav-tab"><?php esc_html_e('Settings', 'cookienod-extended'); ?></a>
        </div>

        <!-- Generate Tab -->
        <div id="generate" class="cookienod-tab-content">
            <h2><?php esc_html_e('Generate Cookie Policy', 'cookienod-extended'); ?></h2>

            <p><?php esc_html_e('Select a template to generate your cookie policy:', 'cookienod-extended'); ?></p>
                    ...
                    <div class="policy-template" data-template="<?php echo esc_attr($cookienod_key); ?>">
                        ...
                        <div class="template-description">
                            ...
                            $cookienod_descriptions = array(
                                'gdpr' => esc_html__('Best for businesses targeting EU customers. Includes detailed GDPR compliance sections.', 'cookienod-extended'),
                                'ccpa' => esc_html__('Best for businesses targeting California customers. Includes CCPA-specific sections.', 'cookienod-extended'),
                                'combined' => esc_html__('Best for international businesses. Covers both GDPR and CCPA requirements.', 'cookienod-extended'),
                                'simple' => esc_html__('Best for smaller businesses. A concise, general-purpose policy.', 'cookienod-extended'),
                            );
            ...
            <p>
                <button type="button" class="button button-primary" id="generate-policy"
                    ...
                    <?php esc_html_e('Generate Policy', 'cookienod-extended'); ?>
                </button>
            </p>

            <?php if (empty($cookienod_detected_cookies)) : ?>
                <div class="notice notice-warning">
                    <p><?php esc_html_e('Please visit your website to detect cookies first. The policy will be generated based on detected cookies.', 'cookienod-extended'); ?></p>
                    <p>
                        <a href="<?php echo esc_url(admin_url('admin.php?page=cookienod-cookies')); ?>" class="button">
                            <?php esc_html_e('Go to Cookie Manager', 'cookienod-extended'); ?>
                        </a>
                    </p>
                </div>
            <?php endif; ?>
            ...
            <div id="policy-preview-container" style="display:none;">
                <h3><?php esc_html_e('Preview', 'cookienod-extended'); ?></h3>
                ...
                <p>
                    <?php if ($cookienod_policy_page) : ?>
                        <button type="button" class="button button-primary" id="update-policy-page"
                            ...
                            <?php esc_html_e('Update Policy Page', 'cookienod-extended'); ?>
                        </button>
                    <?php else : ?>
                        <button type="button" class="button button-primary" id="create-policy-page">
                            <?php esc_html_e('Create Policy Page', 'cookienod-extended'); ?>
                        </button>
                    <?php endif; ?>
                </p>
            </div>
        ...
        <div id="detected-cookies" class="cookienod-tab-content" style="display:none;">
            <h2><?php esc_html_e('Detected Cookies', 'cookienod-extended'); ?></h2>
                ...
                printf(
                    esc_html(
                        sprintf(
                            ...
                            __('Total cookies detected: %s', 'cookienod-extended'),
        ...
        <div id="settings" class="cookienod-tab-content" style="display:none;">
            <form method="post" action="options.php">
                ...
                <h2><?php esc_html_e('Policy Settings', 'cookienod-extended'); ?></h2>

                <table class="form-table">
                    <tr>
                        <th><?php esc_html_e('Auto-Update Policy', 'cookienod-extended'); ?></th>
                        <td>
                            <label>
                                ...
                                <?php esc_html_e('Automatically update policy page when new cookies are detected', 'cookienod-extended'); ?>
                            </label>
                        </td>
                    </tr>

                    <tr>
                        <th><?php esc_html_e('Show Last Updated', 'cookienod-extended'); ?></th>
                        <td>
                            <label>
                                ...
                                <?php esc_html_e('Display "Last Updated" date on policy page', 'cookienod-extended'); ?>
                            </label>
                        </td>
                    </tr>

                    <tr>
                        <th><?php esc_html_e('Company Name', 'cookienod-extended'); ?></th>
                        <td>
                    ...
                    <tr>
                        <th><?php esc_html_e('Contact Email', 'cookienod-extended'); ?></th>
                        <td>
            ...
            <h3><?php esc_html_e('Shortcodes', 'cookienod-extended'); ?></h3>

            <table class="widefat striped">
                <thead>
                    <tr>
                        <th><?php esc_html_e('Shortcode', 'cookienod-extended'); ?></th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?php esc_html_e('Display the full cookie policy', 'cookienod-extended'); ?></td>
                    </tr>
                    <tr>
                        <td><code>[cookienod_cookie_table category="analytics"]</code></td>
                        <td><?php esc_html_e('Display a table of cookies (optional category filter)', 'cookienod-extended'); ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
wp_enqueue_style(
    ...
    COOKIENOD_EXTENDED_PLUGIN_URL . 'assets/css/policy-generator.css',
    array(),
