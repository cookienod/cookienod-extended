    ...
    <div class="cookienod-css-editor">
        <div class="cookienod-css-sidebar">
            <div class="cookienod-card">
                <h2><?php esc_html_e('Style Presets', 'cookienod-extended'); ?></h2>

                <p><?php esc_html_e('Current banner theme (from Settings):', 'cookienod-extended'); ?></p>
                <p>
                    ...
                    <small class="description"><?php esc_html_e('Change in Settings page', 'cookienod-extended'); ?></small>
                </p>

                <hr>

                <p><?php esc_html_e('Load preset CSS style:', 'cookienod-extended'); ?></p>

                <select id="theme-selector">
                    <option value=""><?php esc_html_e('-- Select a style preset --', 'cookienod-extended'); ?></option>
                ...
                <p>
                    <button type="button" class="button" id="load-theme">
                        <?php esc_html_e('Load Preset', 'cookienod-extended'); ?>
                    </button>
                </p>

                <hr>

                <h3><?php esc_html_e('Safe CSS Properties', 'cookienod-extended'); ?></h3>

                <p class="description">
                    <?php esc_html_e('You can use these CSS properties:', 'cookienod-extended'); ?>
                </p>
                ...
                <h3><?php esc_html_e('Safe Selectors', 'cookienod-extended'); ?></h3>
...
.cs-banner-title, .cs-banner-description, .cs-settings-title</code>
            ...
            <div class="cookienod-card">
                <h2><?php esc_html_e('Actions', 'cookienod-extended'); ?></h2>

                <p>
                    <button type="button" class="button" id="preview-css">
                        <?php esc_html_e('Preview Changes', 'cookienod-extended'); ?>
                    </button>
                </p>

                <p>
                    <button type="button" class="button" id="validate-css">
                        <?php esc_html_e('Validate CSS', 'cookienod-extended'); ?>
                    </button>
                </p>

                <p>
                    <button type="button" class="button button-link-delete" id="reset-css">
                        <?php esc_html_e('Reset to Default', 'cookienod-extended'); ?>
                    </button>
                </p>
            </div>
        </div>
        ...
        <div class="cookienod-css-main">
            <div class="cookienod-card">
                <h2><?php esc_html_e('Custom CSS', 'cookienod-extended'); ?></h2>
                ...
                <form method="post" action="options.php">
                    ...
                    <p class="description">
                        <?php esc_html_e('Only safe CSS properties are allowed. JavaScript and potentially dangerous CSS will be automatically removed.', 'cookienod-extended'); ?>
                    </p>

                    <p id="css-validation-status"></p>

                    <?php submit_button(__('Save CSS', 'cookienod-extended')); ?>
                </form>
            </div>

            <div class="cookienod-card">
                <h2><?php esc_html_e('Live Preview', 'cookienod-extended'); ?></h2>

                <p><?php esc_html_e('Preview how your banner will look:', 'cookienod-extended'); ?></p>
                <p class="description"><?php printf(
                    /* translators: %s: Banner theme name */
                    esc_html__('Base banner theme from Settings: %s. Custom CSS presets are applied as overrides on top of that theme.', 'cookienod-extended'),
...
wp_enqueue_style(
    ...
    COOKIENOD_EXTENDED_PLUGIN_URL . 'assets/css/custom-css-editor.css',
    array(),
