    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
        ...
        <?php if ($cookienod_last_detected) : ?>
            <span style="color: #666; font-size: 0.9em;">
                ...
                printf(esc_html__('Last updated: %s ago', 'cookienod-extended'), esc_html(human_time_diff(strtotime($cookienod_last_detected), current_time('timestamp'))));
                ?>
            </span>
        <?php endif; ?>
    </div>
    ...
    <?php if ($cookienod_total > 0) : ?>
        ...
        <div class="cookienod-card">
            <div class="nav-tab-wrapper">
                <a href="#all" class="nav-tab nav-tab-active" data-category="all"><?php esc_html_e('All Cookies', 'cookienod-extended'); ?> (<?php echo esc_html($cookienod_total); ?>)</a>
            ...
            <div style="padding: 15px; background: #f9f9f9; border-bottom: 1px solid #ddd;">
                <input type="text" id="cookie-search" class="regular-text"
                       placeholder="<?php esc_attr_e('Search cookies...', 'cookienod-extended'); ?>"
...
<!-- Cookie Table -->
            <table class="wp-list-table widefat striped" id="cookies-table">
                <thead>
                    <tr>
                        <th style="width: 30%;"><?php esc_html_e('Cookie Name', 'cookienod-extended'); ?></th>
                        <th style="width: 15%;"><?php esc_html_e('Category', 'cookienod-extended'); ?></th>
                        <th style="width: 15%;"><?php esc_html_e('Type', 'cookienod-extended'); ?></th>
                        <th><?php esc_html_e('Source', 'cookienod-extended'); ?></th>
        ...
        <div class="cookienod-card" style="margin-top: 20px;">
            <h2><?php esc_html_e('Cookie Categories Explained', 'cookienod-extended'); ?></h2>
            <table class="widefat" style="border: none;">
                <tbody>
                    <tr>
                        ...
                        <td><strong><?php esc_html_e('Necessary', 'cookienod-extended'); ?></strong></td>
                        <td><?php esc_html_e('Essential cookies required for the website to function properly. Cannot be disabled.', 'cookienod-extended'); ?></td>
                    </tr>
                    <tr>
                        ...
                        <td><strong><?php esc_html_e('Functional', 'cookienod-extended'); ?></strong></td>
                        <td><?php esc_html_e('Enable enhanced functionality and personalization, such as language preferences.', 'cookienod-extended'); ?></td>
                    </tr>
                    <tr>
                        ...
                        <td><strong><?php esc_html_e('Analytics', 'cookienod-extended'); ?></strong></td>
                        <td><?php esc_html_e('Help understand how visitors interact with the website (Google Analytics, etc.).', 'cookienod-extended'); ?></td>
                    </tr>
                    <tr>
                        ...
                        <td><strong><?php esc_html_e('Marketing', 'cookienod-extended'); ?></strong></td>
                        <td><?php esc_html_e('Used to track visitors across websites to deliver relevant advertisements.', 'cookienod-extended'); ?></td>
                    </tr>
                    <tr>
                        ...
                        <td><strong><?php esc_html_e('Uncategorized', 'cookienod-extended'); ?></strong></td>
                        <td><?php esc_html_e('Cookies that have not yet been classified into a category.', 'cookienod-extended'); ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <?php else : ?>
        ...
        <div class="cookienod-card">
            <div class="cookienod-empty-state" style="text-align: center; padding: 40px;">
                <h3><?php esc_html_e('No Cookies Detected Yet', 'cookienod-extended'); ?></h3>
                <p>
                    <?php esc_html_e('Cookies will be detected automatically when visitors browse your website.', 'cookienod-extended'); ?>
                </p>
                <p style="margin: 20px 0;">
                    <a href="<?php echo esc_url(home_url()); ?>" target="_blank" class="button button-primary">
                        <?php esc_html_e('Visit Your Site to Detect Cookies', 'cookienod-extended'); ?>
                    </a>
                </p>
                <p style="color: #666;">
                    <em><?php esc_html_e('The CookieNod JavaScript detects cookies as they are set in users\' browsers. Visit your site and accept cookies to trigger detection.', 'cookienod-extended'); ?></em>
                </p>
            </div>
        </div>
