    ...
    <?php if ($cookienod_total > 0) : ?>
        <div class="cookienod-dashboard-grid">
            <div class="cookienod-card">
                <div class="cookienod-stat">
                    ...
                    <span class="cookienod-stat-label">
                        <span class="cookienod-category-badge necessary"><?php esc_html_e('Necessary', 'cookienod-extended'); ?></span>
                    </span>
                </div>
            </div>
            ...
            <div class="cookienod-card">
                <div class="cookienod-stat">
                    ...
                    <span class="cookienod-stat-label">
                        <span class="cookienod-category-badge functional"><?php esc_html_e('Functional', 'cookienod-extended'); ?></span>
                    </span>
                </div>
            </div>
            ...
            <div class="cookienod-card">
                <div class="cookienod-stat">
                    ...
                    <span class="cookienod-stat-label">
                        <span class="cookienod-category-badge analytics"><?php esc_html_e('Analytics', 'cookienod-extended'); ?></span>
                    </span>
                </div>
            </div>
            ...
            <div class="cookienod-card">
                <div class="cookienod-stat">
                    ...
                    <span class="cookienod-stat-label">
                        <span class="cookienod-category-badge marketing"><?php esc_html_e('Marketing', 'cookienod-extended'); ?></span>
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="cookienod-card">
            ...
            <div class="tablenav top">
                <div class="alignleft actions">
                    <label for="cookie-category-filter" class="screen-reader-text">
                        <?php esc_html_e('Filter by category', 'cookienod-extended'); ?>
                    </label>
                    <select id="cookie-category-filter">
                        <option value="all"><?php esc_html_e('All Categories', 'cookienod-extended'); ?></option>
                        <option value="necessary"><?php esc_html_e('Necessary', 'cookienod-extended'); ?></option>
                        <option value="functional"><?php esc_html_e('Functional', 'cookienod-extended'); ?></option>
                        <option value="analytics"><?php esc_html_e('Analytics', 'cookienod-extended'); ?></option>
                        <option value="marketing"><?php esc_html_e('Marketing', 'cookienod-extended'); ?></option>
                        <option value="uncategorized"><?php esc_html_e('Uncategorized', 'cookienod-extended'); ?></option>
                    </select>

                    <input type="text" id="cookie-search" placeholder="<?php esc_attr_e('Search cookies...', 'cookienod-extended'); ?>"
                           class="regular-text" />
                </div>
            </div>
            ...
            <table class="wp-list-table widefat striped cookienod-scan-table" id="cookie-scan-table">
                <thead>
                    <tr>
                        <th><?php esc_html_e('Cookie Name', 'cookienod-extended'); ?></th>
    ...
    <?php else : ?>
        ...
        <div class="cookienod-card">
            <div class="cookienod-empty-state">
                ...
                <p>
                    <?php esc_html_e('Run a scan to detect cookies on your website. The scan will analyze your site\'s cookies and categorize them automatically.', 'cookienod-extended'); ?>
                </p>

                <p><?php esc_html_e('Note: For best results, visit your website in an incognito window after activating the plugin to trigger the JavaScript scanner.', 'cookienod-extended'); ?></p>
            </div>
        </div>
